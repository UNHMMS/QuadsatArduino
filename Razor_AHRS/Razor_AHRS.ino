...
#define ACCEL_Y_MAX ((float) 294)
#define ACCEL_Z_MIN ((float) -293)
#define ACCEL_Z_MAX ((float) 228)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -186)
#define MAGN_X_MAX ((float) 144)
#define MAGN_Y_MIN ((float) -55)
#define MAGN_Y_MAX ((float) 268)
#define MAGN_Z_MIN ((float) -115)
#define MAGN_Z_MAX ((float) 110)
...
#define GYRO_AVERAGE_OFFSET_X ((float) -16.11)
#define GYRO_AVERAGE_OFFSET_Y ((float) 39.28)
#define GYRO_AVERAGE_OFFSET_Z ((float) -12.45)
