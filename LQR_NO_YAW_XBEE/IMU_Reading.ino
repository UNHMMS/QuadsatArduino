...
void updateIMU()
{
  ...
  */
  ...
  filterAngle[0] = COMPRATIO * ( lastCompAngle[0] + gyroFlt[0] * timeStep ) + (1 - COMPRATIO) * axlAngle[1];
  filterAngle[1] = COMPRATIO * ( lastCompAngle[1] + gyroFlt[1] * timeStep ) + (1 - COMPRATIO) * axlAngle[0];
