...
void MPULib::getAxlData(short buff[]){
byte buffer[6];
...
/////////////////////////////Edited by Drew///////////////////////////////
void MPULib::getGyroData(short buff[])
{
...
void MPULib::getMagData(short buff[])
{
byte buffer[6];
...
///////////////////////////////////Added by Drew///////////////////////////
unsigned char MPULib::gyroRead(char address, char registerAddress)
{
