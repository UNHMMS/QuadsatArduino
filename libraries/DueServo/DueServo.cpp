 ...
 */
 ...
 uint8_t DueServo::attach(int pin)
 {
   return this->attach(pin, MIN_PULSE_WIDTH, MAX_PULSE_WIDTH);
 }
 
 uint8_t DueServo::attach(int pin, int min, int max)
 {
   timer16_Sequence_t timer;
 ...
 void DueServo::writeMicroseconds(int value)
 {
 ...
 int DueServo::read() // return the value as degrees
 {
   return map(readMicroseconds()+1, SERVO_MIN(), SERVO_MAX(), 0, 180);
 }
 
 int DueServo::readMicroseconds()
 {
